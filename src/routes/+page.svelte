...
<div class="layout-md text-lg">
  ...
  <header class="home-header" in:fly={{ y: 20, duration: 800, delay: 200 }}>
    <div class="home-header-text">
      <p class="home-tagline">
        <span class="muted">is an</span> aspiring polymath,<span class="muted"> </span> <br />
        researcher<span class="muted">,</span> engineer<span class="muted">,</span> <br />
        <span class="muted">and</span> builder<span class="muted">.</span>
      </p>

      <div class="home-bio mt-6 space-y-5">
        <p>
          ...
          />
          advised by
          <a href="https://emjun.github.io" class="link">Eunice Jun</a> at the
          <span class="chip-phrase">
            <OrgChip
              name="C&DL"
              href="https://ucla-cdl.org"
              color={orgColor.cdl.light}
              darkColor={orgColor.cdl.dark}
              logoSrc="/logos/candle.svg"
              ariaLabel="Computation & Discovery Lab"
            />.
          </span>
          I work at the intersection of HCI and AI, developing models and software that empowers people
          to <em>think</em>, <em>learn</em>, and <em>create</em>.
        </p>
        ...
        <p>
          ...
          <OrgChip
            ...
            logo={excavaiteLogo}
          />, an agentic Intellectual Property mining and protection platform.
        </p>
        ...
        <p>
          ...
          <OrgChip
            ...
            logo={confluentLogo}
          />
          on core Kafka Metadata. Earlier, I trained CV models for grape and leaf-mineral analysis at
          <span class="chip-phrase">
            <OrgChip
              name="Agrofocal"
              ...
              logoSrc="/logos/agrofocal.ico"
            />,
          </span>
          and explored diffusion for autonomous-vehicle perception and sythetic data augmentation in the
          <OrgChip
            name="UCLA VAIL Lab"
  ...
  <section class="reveal mt-16 sm:mt-20" use:inview>
    <h2 class="heading2">
      <span class="text-sunset-amber-300 mr-2 font-mono text-base font-normal">//</span>selected
      work
    </h2>
    <ul class="space-y-2">
      {#each selectedWork as item}
        <li>
          <a href={item.href} target="_blank" rel="noopener noreferrer" class="work-link">
            ...
            <span class="work-desc">
              {item.desc}
              {#if item.aside}
                <span class="aside" class:paper={item.kind === "paper"}>— {item.aside}</span>
              {/if}
            </span>
          </a>
        </li>
